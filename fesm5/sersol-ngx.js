import { __decorate, __param, __values, __read, __awaiter, __generator, __spread } from 'tslib';
...
var AWS_CONFIG = new InjectionToken('aws.config');
/**
 * @description
...
var NG_GAPI_CONFIG = new InjectionToken('google.config');
/**
 * @description
...
var NG_FSDK_CONFIG = new InjectionToken('facebook.config');
/**
 * @description
    ...
    LeafletMap.prototype.fitMarkersBounds = function (padding, flyTo) {
        if (hasValue(this.markers)) {
            ...
            if (hasValue(groupWrapper)) {
                ...
                var group = featureGroup(groupWrapper);
                if (flyTo) {
