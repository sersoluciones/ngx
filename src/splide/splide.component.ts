...
export class SplideComponent implements AfterViewInit, OnChanges, OnDestroy {
    ...
    @ContentChildren(SplideSlideComponent) public slides: QueryList<SplideSlideComponent>;

    @ViewChild('splideElement') splideElement: ElementRef<HTMLElement>;
    ...
    ngAfterViewInit() {
        ...
        const slidesSubscription = this.slides.changes
            .subscribe((list: QueryList<SplideSlideComponent>) => {
