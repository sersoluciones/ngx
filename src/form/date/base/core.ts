    ...
    protected init() {
        if (this.options.plugins && this.options.plugins.length) {
            this.options.plugins.forEach((plugin) => {
                if (Datepicker.prototype.hasOwnProperty(plugin)) {
                    Datepicker.prototype[plugin].init.call(this, this);
                } else {
