...
export default class DatepickerBody {
    ...
    _getDayNamesHtml(firstDay = this.dp.locale.firstDay) {
        ...
        while (i < totalDays) {
            ...
            const className = classNames('air-datepicker-body--day-name', {
    ...
    handleDayNameClick = (e) => {
        const index = e.target.getAttribute('data-day-index');
