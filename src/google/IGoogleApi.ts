...
export declare namespace gapi {
     ...
     */
    function load(apiName: string, callback: CallbackOrConfig): void;

}

export declare namespace gapi.auth {
    /**
...
export declare namespace gapi.auth2 {
  /**
...
export declare namespace gapi.signin2 {
...
export declare namespace gapi.client {
    /**
